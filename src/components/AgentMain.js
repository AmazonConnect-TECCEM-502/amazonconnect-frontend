  ...
  return (
    <div className="agent-container">
      <AgentBoard id="board-1" className="board">
        <Card id="card-1" draggable="true" component = {<Menu/>}/>
      ...
      <AgentBoard id="board-2" className="board">
        ...
        <Card id="card-5" draggable="true" component = {<UserCard  image = "TelmexLogo" 
                                      fname = "John" 
                                      lname = "Doe"
                                      email = "example@gmail.com"
                                      phone = "55 5555 5555" />}/>
        <Card id="card-6" draggable="true" component = {<ProductCard image = "ejemploTelmex"
